...
if [ $(hostname) == geodynamiker ] 
then
  xrandr --output VGA-0 --mode 1920x1080 --pos 2560x0 --rotate left --output DVI-D-0 --primary --mode 2560x1600 --pos 0x0 --rotate normal --output HDMI-0 --off
fi
